...
## Verification Plan
- Verify CPF calculations still work with 'Singapore Citizen'.
- Verify SPR fields appear when 'SPR' is selected.
- Verify new languages are available in the dropdown.
