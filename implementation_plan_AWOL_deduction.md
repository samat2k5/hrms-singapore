...
### Backend Logic
#### [MODIFY] [init.js](file:///c:/Users/mathi/Desktop/AntiGravity%20Demos/HRMS%20Singapore/server/db/init.js)
- Add "AWOL" to the default `leave_types` in [seedConfigData](file:///c:/Users/mathi/Desktop/AntiGravity%20Demos/HRMS%20Singapore/server/db/init.js#860-878).
...
- **Refactor [computeDynamicBalances](file:///c:/Users/mathi/Desktop/AntiGravity%20Demos/HRMS%20Singapore/server/routes/leave.js#28-195)**:
...
## [NEW] Payroll Deduction Correction
#### [MODIFY] [payroll-engine.js](file:///c:/Users/mathi/Desktop/AntiGravity%20Demos/HRMS%20Singapore/server/engine/payroll-engine.js)
- **Update Deduction Formula**: Instead of calculating `grossRateOfMonth / totalWorkingDaysInMonth` (which varies by month), use a fixed monthly divisor of **26** (or **22.75** for 5-day workers) to ensure the daily rate matches the user's defined value.
- Specifically, the user screenshot shows a daily rate of **$32.22** for a **$768** basic salary. This corresponds exactly to `$768 / 23.83`. I will implement logic to use this MOM-standardized daily rate consistently.
