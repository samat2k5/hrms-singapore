...
- **Improved Button Consistency**: Standardized the "+Add Employee" button styling on the Employees page.
- **Dark Mode Accessibility**: Lightened the primary brand color (`#a855f7`) in dark mode to ensure clear visibility for Employee IDs and interactive elements across all pages.
...
- **Enhanced Filtering**:
    - Added a functional **Status** filter (Active, Inactive, Resigned).
    - Standardized filter background and text styling for theme consistency.
- **Simplified Data View**: 
    - Removed the redundant Employment column.
    - Integrated **Department** and **Group** badges into the Name & Designation column for a cleaner, higher-density view.
