        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-slate-400 mt-1">Manage corporate departments for {activeEntity?.name || 'this entity'}.</p>
                </div>
                {canEditConfigs && (
                    <button onClick={handleAdd} className="gradient-btn">+ Add Department</button>
                )}
            </div>
                    ...
                    <table className="table-glass w-full">
                        ...
                        <tbody>
                            ...
                            {departments.length === 0 && (
                                <tr>
                                    <td colSpan="3" className="text-center py-8 text-slate-500">No departments found.</td>
                                </tr>
                            )}
                        </tbody>
                    </table>
            ...
            {showModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in">
                    <div className="glass-card p-6 w-full max-w-md animate-slide-up" style={{ background: 'rgba(15, 23, 42, 0.95)' }}>
                        <h2 className="text-xl font-bold text-white mb-6">{editing ? 'Edit' : 'Add'} Department</h2>
