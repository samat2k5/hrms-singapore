...
26. 
27. ## Payroll Deduction Correction (Consistency & Compliance)
28. 
29. I have standardized the deduction logic for absences (Unpaid Leave and AWOL) to ensure consistency with defined daily rates.
30. 
31. ### Key Correction:
32. - **Standardized Monthly Constant**: Instead of calculating deductions based on the *actual* working days of a specific month (which causes the daily rate to fluctuate), the system now uses the **MOM Standardized Monthly Constant**:
33.    - **22.75 days** for 5-day workers.
34.    - **23.83 days** for 5.5-day workers.
35.    - **26 days** for 6-day workers.
36. - **Result**: For a basic salary of **$768** (5.5-day worker), the daily rate is now fixed at **$32.22** ($768 / 23.83$), ensuring the 2-day AWOL deduction is exactly **$64.44**, as expected by the user.
37. - **Compliance**: This maintains MOM compliance for Section 28 (Deduction for Absence) while preventing the monthly fluctuation of daily rates that was affecting payroll accuracy.
38. 
...
- **Deduction Consistency**: Verified that the daily rate for employee R52 is now consistently $32.22, leading to correct $64.44 deductions for 2 days of absence, resolving the earlier discrepancy.
