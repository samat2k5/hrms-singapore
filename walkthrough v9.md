...
### 7. Localization: Labels & Languages
Refined the terminology and expanded regional support:
- **Nationality Labels**: Updated throughout the system (DB, Engine, UI):
    - `Citizen` → **Singapore Citizen**
    - [PR](file:///c:/Users/mathi/Desktop/AntiGravity%20Demos/HRMS%20Singapore/server/engine/cpf-engine.js#56-64) → **SPR**
- **New Languages**: Added specific regional support for:
    - **Bengali**
    - **Telugu**
    - **Hindi**
- **Data Migration**: Successfully migrated all existing records to the new labeling standard.
